...
export interface ReadMoreDecisionHubProps {
  article: Article;
  tier?: 'briefing' | 'analytical' | 'full';
...
export const ReadMoreDecisionHub: React.FC<ReadMoreDecisionHubProps> = (props) => {
  const {
    article,
    tier,
    currentTier,
...
export default ReadMoreDecisionHub;
