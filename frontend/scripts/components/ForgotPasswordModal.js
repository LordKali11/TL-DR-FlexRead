const { useState, useEffect } = React;
    ...
    function ForgotPasswordModal({ isOpen, initialEmail = '', onClose, onSubmitSuccess }) {
      ...
      return (
        <div className="nzz-modal-backdrop" onClick={handleBackdropClick} role="dialog" aria-modal="true" aria-labelledby="modal-title">
